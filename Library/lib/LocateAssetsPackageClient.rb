require 'net/http'
require 'json'
require_relative 'clients/PropertySearchClient'

module LocateAssetsPackage
  class LocateAssetsPackageClient
    attr_reader :authorization, :property_search_client, :base_uri
    ...
    def initialize(client_id, client_secret, environment_type = EnvironmentType::Production)
      ...
      @property_search_client = LocateAssetsPackage::APIClients::PropertySearchClient.new(@authorization, @base_uri)
    end
